...
pandoc --extract-media ./images -o "ASG_API Playbook_01.03 Introduction Section_01.04_Publication Review {Paul}.md" "ASG_API Playbook_01.03 Introduction Section_01.04_Publication Review {Paul}.docx"
pause
