...
powershell -Command "<a href='%aRepo%' target="_blank">Wiki source content can be found here.</a> + (13 -as [char]) + (10 -as [char]) + (gc '%aFile%.mediawiki' -encoding UTF8 | Out-String) | Out-File '%aFile%.mediawiki'" -encoding UTF8
