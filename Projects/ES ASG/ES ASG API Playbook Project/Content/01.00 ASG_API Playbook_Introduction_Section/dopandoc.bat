...
rem Insert URL of content
powershell -Command "'Wiki source contents can be viewed at:' + (13 -as [char]) + (10 -as [char]) + '%aRepo%' + (13 -as [char]) + (10 -as [char]) + (gc '%aFile%.mediawiki' -encoding UTF8 | Out-String) | Out-File '%aFile%.mediawiki'" -encoding UTF8
