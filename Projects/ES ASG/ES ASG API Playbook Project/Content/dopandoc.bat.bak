...
powershell -Command "'<p><a href=mailto:ron.opperman@va.gov;paul.marshall4@va.gov?subject=' + '%aFile%' + '>Send Feedback to this page Via Email</a></p>' + (13 -as [char]) + (10 -as [char]) + (gc '%aFile%.mediawiki' -encoding UTF8 | Out-String) | Out-File '%aFile%.mediawiki'" -encoding UTF8
