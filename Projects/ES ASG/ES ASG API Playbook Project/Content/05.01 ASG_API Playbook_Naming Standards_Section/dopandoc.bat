set aImage="https://github.com/department-of-veterans-affairs/ES-ASG/raw/master/Projects/ES%%20ASG/ES%%20ASG%%20API%%20Playbook%%20Project/Content/05.01%%20ASG_API%%20Playbook_Naming%%20Standards_Section/media/"
